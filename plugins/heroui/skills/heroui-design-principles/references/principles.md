# HeroUI v3 Core Design Principles

**Category:** react  
**URL:** https://heroui.com/en/docs/react/getting-started/design-principles  
**Source MDX:** https://raw.githubusercontent.com/heroui-inc/heroui/refs/heads/v3/apps/docs/content/docs/en/react/getting-started/(overview)/design-principles.mdx
...
Use semantic naming (`primary`, `secondary`, `tertiary`) instead of visual descriptions (`solid`, `flat`, `bordered`). Inspired by [Uber's Base design system](https://base.uber.com/6d2425e9f/p/756216-button), variants follow a clear hierarchy of emphasis.
...
Built on [React Aria Components](https://react-spectrum.adobe.com/react-aria/) for WCAG 2.1 AA compliance. Automatic ARIA attributes, keyboard navigation, and screen reader support are included — do not reimplement them.
...
Prefer `onPress` over `onClick` on interactive HeroUI components.
...
Prefer patterns that stay legible to humans and agents: semantic names, compound structure, shared size/variant scales.
...
Wrap, extend, and customize components to match your needs. Use variant functions, direct BEM class application, or custom wrappers.
