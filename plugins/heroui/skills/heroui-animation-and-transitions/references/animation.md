# HeroUI v3 Animation Reference

**Category:** react  
**URL:** https://heroui.com/en/docs/react/getting-started/animation  
**Source MDX:** https://raw.githubusercontent.com/heroui-inc/heroui/refs/heads/v3/apps/docs/content/docs/en/react/getting-started/(handbook)/animation.mdx
...
```tsx
// Pulse on hover
<Button className="hover:animate-pulse">Hover me</Button>

// Fade in entrance
<Alert className="animate-fade-in">Welcome message</Alert>
...
Add `data-reduce-motion="true"` to the `<html>` or `<body>` tag:
...
- Composition skill: `heroui-composition-patterns`
- Design principles: `heroui-design-principles`
