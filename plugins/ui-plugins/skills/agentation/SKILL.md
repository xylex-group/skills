---
name: agentation
description: Add Agentation visual feedback toolbar to a Next.js project. Use when the user asks about agentation, needs to implement or review agentation code, or runs related commands.
---
